...
export function Footer() {
  return (
    <footer className="border-t border-border py-16 px-4 md:px-8 lg:px-12 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-orange/5 rounded-full blur-[150px] -z-10 opacity-30" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 relative z-10">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 px-8 py-5 bg-surface/30 backdrop-blur-md border border-white/10 rounded-2xl hover:border-orange/30 hover:bg-surface/50 transition-all duration-300">
